...
const req = function (url, method, params, requestHeader, fileConfig = {}) {
  ...
  let requestConfig = {
    url: url,
    method: method,
    params: Object.assign({}, params, {access_token:JSON.parse(sessionStorage.getItem('user')).access_token}),
    data: qs.stringify(Object.assign({}, params, {access_token:JSON.parse(sessionStorage.getItem('user')).access_token})),
    headers: {},
